...
export function SettingsSection({ id, title, description, children, onSave, canEdit }: { id?:string; title:string; description:string; children:ReactNode; onSave:()=>Promise<void>; canEdit:boolean }) {
