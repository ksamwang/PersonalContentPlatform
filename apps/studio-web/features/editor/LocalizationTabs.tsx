...
export function LocalizationTabs({workspace,content,active,canEdit,onSelect,onCreated}:{workspace:string;content:Content;active:string;canEdit:boolean;onSelect:(id:string)=>void;onCreated:(content:Content,targetID:string)=>void}){
