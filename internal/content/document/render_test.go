...
func TestHTMLRendersRichContent(t *testing.T) {
	...
	got := HTML(input)
	for _, want := range []string{`<a href="https://example.com"><strong>Read</strong></a>`, `<img src="/media/123/content-1280" alt="示例图片" width="480"`, `srcset="/media/123/thumbnail 480w, /media/123/content-1280 1280w`, `<table>`} {
